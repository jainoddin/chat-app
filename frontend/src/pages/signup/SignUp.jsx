            ...
            <form onSubmit={handleSubmit}>
             <div>
              ...
              <div>
                ...
                <input type='text' placholder='Johndeo' className='w-full input input-bordered h-10'
              ...
              <Link to='/login' className='text-sm hover:underline hover:text-blue-600 mt-1 inline-block' > Already have an acount?</Link>
